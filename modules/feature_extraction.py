...
def get_all_features(x: np.ndarray, name: str, dt: float) -> Tuple[List, List]:
    features, names = [], []

    handle = name + ' - '
    temporal = get_temporal_metrics(x)
...
def get_temporal_metrics(x: np.ndarray) -> Dict:
